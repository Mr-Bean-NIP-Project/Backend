...
export class Init1681715060867 implements MigrationInterface {
    name = 'Init1681715060867'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "material_product" ("material_id" integer NOT NULL, "product_id" integer NOT NULL, "material_quantity" varchar NOT NULL, "created_at" datetime NOT NULL DEFAULT (datetime('now')), "updated_at" datetime NOT NULL DEFAULT (datetime('now')), PRIMARY KEY ("material_id", "product_id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_material_product" ("material_id" integer NOT NULL, "product_id" integer NOT NULL, "material_quantity" varchar NOT NULL, "created_at" datetime NOT NULL DEFAULT (datetime('now')), "updated_at" datetime NOT NULL DEFAULT (datetime('now')), CONSTRAINT "FK_b4f92677ba1ae798c1971908412" FOREIGN KEY ("material_id") REFERENCES "material" ("id") ON DELETE CASCADE ON UPDATE CASCADE, CONSTRAINT "FK_317e70d8f17cc0c17a74b0f3a46" FOREIGN KEY ("product_id") REFERENCES "product" ("id") ON DELETE CASCADE ON UPDATE CASCADE, PRIMARY KEY ("material_id", "product_id"))`);
        await queryRunner.query(`INSERT INTO "temporary_material_product"("material_id", "product_id", "material_quantity", "created_at", "updated_at") SELECT "material_id", "product_id", "material_quantity", "created_at", "updated_at" FROM "material_product"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "material_product" ("material_id" integer NOT NULL, "product_id" integer NOT NULL, "material_quantity" varchar NOT NULL, "created_at" datetime NOT NULL DEFAULT (datetime('now')), "updated_at" datetime NOT NULL DEFAULT (datetime('now')), PRIMARY KEY ("material_id", "product_id"))`);
        await queryRunner.query(`INSERT INTO "material_product"("material_id", "product_id", "material_quantity", "created_at", "updated_at") SELECT "material_id", "product_id", "material_quantity", "created_at", "updated_at" FROM "temporary_material_product"`);
